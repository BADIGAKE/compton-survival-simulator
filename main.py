...
function ending_cutscene () {
    ...
    saviour.sayText("hello sigma", 2000, false)
    timer.after(2000, function () {
        compton_himself.sayText("omg jesus", 2000, false)
        timer.after(2000, function () {
            saviour.sayText("let us be saved together", 2000, false)
            timer.after(2000, function () {
                compton_himself.sayText("holy sigma", 2000, false)
                timer.after(2000, function () {
                    saviour.sayText("lets go skibidi", 1000, false)
                    timer.after(1000, function () {
                        ...
                        compton_himself.sayText("ok sigma", 500, false)
